...
import com.example.tugas_actionbar.databinding.FragmentLoginBinding
        ...
        with(binding) {
            btLoginLogin.setOnClickListener {
                if (etLoginPass.text.toString() == "" ||  etLoginUsername.text.toString() == ""){
                    ...
                    val intentToHome = Intent(requireContext(), com.example.tugas_actionbar.HomePageActivity::class.java)
